...
#ifndef ANDROIDSYSTEM_TYPEHELPERS_H
#define ANDROIDSYSTEM_TYPEHELPERS_H
...
#define ANDROID_INT64_HASH(T) \
    template<>inline hash_t hash_type(const T& value){return hash_t((value>>32)^value);}
#define ANDROID_REINTERPRET_HASH(T, R) \
    template<>inline hash_t hash_type(const T& value){return hash_type(*reinterpret_cast<const R*>(&value));}
...
#endif //ANDROIDSYSTEM_TYPEHELPERS_H
