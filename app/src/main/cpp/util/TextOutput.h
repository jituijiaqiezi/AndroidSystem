...
#ifndef ANDROIDSYSTEM_TEXTOUTPUT_H
#define ANDROIDSYSTEM_TEXTOUTPUT_H
...
namespace android {
    ...
    public:
        ...
        virtual status_t print(const char *text, size_t len)=0;
...
#endif //ANDROIDSYSTEM_TEXTOUTPUT_H
