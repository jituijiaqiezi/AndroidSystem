...
#ifndef ANDROIDSYSTEM_TIMERS_H
#define ANDROIDSYSTEM_TIMERS_H
...
namespace android {
    ...
    public:
        ...
        static long long subtractTimevals(const struct timeval *ptv1, const struct timeval *ptv2);
